...
public class AppLockAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView !=null && convertView instanceof RelativeLayout){
            ...
            holder.mAppIconImgv = (ImageView) convertView.findViewById(
                    R.id.iv_app_icon);
            holder.mAppNameTV = (TextView) convertView.findViewById(R.id.tv_app_name);
            holder.mLockIcon = (ImageView) convertView.findViewById(R.id.iv_right_img);
