...
public class CleanRubbishActivity extends Activity implements View.
            ...
            switch (msg.what) {
                case CLEANNING:
                    ...
                    if (size == rubbishSize) {
                        ...
                        tv_clean_size.setText("成功清理：" + Formatter.formatFileSize(
                                CleanRubbishActivity.this, rubbishSize));
                    }
                    break;
                case CLEANNING_FAIL:
                    animation.stop();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRubbishInfos= (List<RubbishInfo>) intent.getSerializableExtra(
                "rubbishInfos");
        initData();
    }
    /**
    ...
    private void initView() {
        ...
        animation = (AnimationDrawable) findViewById(R.id.iv_clean_rubbish).
                getBackground();
